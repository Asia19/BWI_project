...
DROP TABLE raw_tagged_unigram_counter;
COPY tagged_unigram_counter_sw TO 'C:/HSE/3_module/BWI_project/data/train_tagged_unigrams_counter_sort-sw.csv' DELIMITER ' ' CSV HEADER;
